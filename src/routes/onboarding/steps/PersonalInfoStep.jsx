...
export const PersonalInfoStep = ({ data, onNext, onPrevious, isFirst }) => {
    ...
    return (
        ...
        >
            ...
            <div>
                <label className="text-dark-700 dark:text-primary-dark-600 mb-2 block text-sm font-medium">{t("full_name")}</label>
                <input
                    type="text"
                    name="fullName"
                    ...
                    className={`text-light-900 dark:border-dark-700 dark:bg-dark-800 dark:text-dark-50 focus:border-light-500 w-full rounded-lg border bg-white px-4 py-2 focus:outline-none ${errors.fullName ? "border-danger-500" : "border-primary-light-600"}`}
                />
                {errors.fullName && <p className="text-danger-500 mt-1 text-sm">{errors.fullName}</p>}
            </div>

            <div>
                <label className="text-dark-700 dark:text-primary-dark-600 mb-2 block text-sm font-medium">{t("email_address")}</label>
                <input
                    type="email"
                    name="email"
                    ...
                    className={`text-light-900 dark:border-dark-700 dark:bg-dark-800 dark:text-dark-50 focus:border-light-500 w-full rounded-lg border bg-white px-4 py-2 focus:outline-none ${errors.email ? "border-danger-500" : "border-primary-light-600"}`}
                />
            ...
            <div>
                ...
                <input
                    ...
                    className={`w-full rounded-lg border ${errors.phone ? "border-danger-500" : "border-primary-light-600"} bg-white px-4 py-2 ${dirFor(t("phone_placeholder")) === "rtl" ? "text-right" : "text-left"} dark:border-dark-700 dark:bg-dark-800 dark:text-dark-50 focus:border-light-500 focus:outline-none`}
                />
                {errors.phone && <p className="text-danger-500 mt-1 text-sm">{errors.phone}</p>}
            </div>

            <div>
                <label className="text-dark-700 dark:text-primary-dark-600 mb-2 block text-sm font-medium">{t("position_role")}</label>
                <input
                    type="text"
                    name="position"
